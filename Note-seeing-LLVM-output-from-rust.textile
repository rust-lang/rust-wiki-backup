...
In your build directory, invoke the Rust compiler with the @-C save-temps@ flag.  It will look something like:

bc. stage2/bin/rustc ../rust/src/test/run-pass/hello.rs -o test/run-pass/hello.stage2 -O -C save-temps
