...
Additionally, the Rust [RFC process](https://github.com/rust-lang/rfcs/blob/master/active/0001-rfc-process.md) continued to mature, and new measures were put into place to make forward porting Rust code to new versions easier, including a [breaking changes log](https://mail.mozilla.org/pipermail/rust-dev/2014-April/009543.html) and increase use of library [deprecation](http://doc.rust-lang.org/rust.html#stability) when making API changes.
