...
* XML
   ...
   * [DanielFath/xml-parser](https://github.com/DanielFath/xml-parser): A hybrid pull, DOM parser written in pure Rust [<img src="https://travis-ci.org/DanielFath/xml-parser?branch=master">](https://travis-ci.org/DanielFath/xml-parser)
