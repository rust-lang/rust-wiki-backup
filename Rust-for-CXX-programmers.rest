...
It is possible to attach a new vtable to an existing struct instance - so one library can take data from another library, without the other having to have even known the interfaces required.
