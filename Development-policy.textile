...
** If it's just new library code, particularly additions to existing modules within the library, write it up in code and send a pull request. No deeper process is really necessary.
** If it's a small-ish semantic or library change, file an issue.
