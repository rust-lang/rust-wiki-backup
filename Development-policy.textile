...
We have an IRC channel on irc.mozilla.org, channel #rust. You're welcome to drop in and ask questions, discuss bugs and such.

There's no mailing list yet. We'll set one up soon, stay tuned.
