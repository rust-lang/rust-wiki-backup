...
If you are already have <a href="http://www.mozilla.org/hacking/commit-access-policy/">Level 1 Access</a> to commit within the Mozilla project, you can request direct commit access to this repository. Email one of the existing authors of this repository and ask if you want to be contributing quickly and regularly this way.
