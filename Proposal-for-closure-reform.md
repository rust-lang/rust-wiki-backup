...
Instead of going for one of the listed options, I instead propose that functions become objects which implement an trait rather than being a distinct type. The full proposal is [here](https://github.com/mozilla/rust/wiki/Proposal-for-function-objects).