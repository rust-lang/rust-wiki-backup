...
Join irc.mozilla.org #rust if you want to discuss anything more "interactively", we try to remain on that channel during working hours in UTC-7 (US Pacific). We'll probably also get a mailing list set up soon, though there are a thousand things to do right now and we're a bit overwhelmed.