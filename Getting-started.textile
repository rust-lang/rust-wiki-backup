...
We recommend developing under the newest "MSYS and MinGW":http://www.mingw.org using their auto-installer.
All instructions will be made in the MSYS Shell.
...
By default the @configure@ script will use Clang if it finds an appropriate version and GCC otherwise. If you want to force use of GCC, define the variable @CFG_ONLY_GCC=1@ in your build environment when running @configure@.
