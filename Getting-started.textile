...
Syntax highlighting for vim is included in the Rust repository, under src/etc/vim. There is also a "rust-mode for emacs":http://github.com/marijnh/rust-mode.
