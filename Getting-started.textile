...
Rust requires a 3.0svn build of LLVM. Follow the instructions on http://clang.llvm.org/get_started.html to check out LLVM (and Clang, if you like).  *Don't follow the build instructions on that page -- see below.*
